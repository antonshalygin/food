...
function forms(formSelector, modalTimerId) {
    ...
    const message = {
        ...
        success: 'Спасибо, вскоре мы с вами свяжемся!',
...
function timer(id, deadline) {
    ...
    function setClock(selector, endtime) {
        const timer = document.querySelectorAll(selector)[0],
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["openModal"])('.modal', modalTimerId), 90000);
